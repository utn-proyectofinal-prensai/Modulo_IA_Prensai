...
def es_declaracion_ollama(texto, ministro_key_words, ministerios_key_words=None):
    ...
    prompt = (
        ...
        "CRITERIOS ESTRICTOS PARA CONSIDERARLO DECLARACIÓN:\n"
        "✅ DEBE tener CITA entre comillas (\"...\" o '...') atribuida a alguno de los actores\n"
        "✅ El actor puede ser referenciado de cualquier forma (directa o indirecta)\n"
        "✅ Debe contener verbos de comunicación/acción (dijo, anunció, informó, expresó, manifestó, etc.)\n"
        "✅ La cita debe estar CLARAMENTE atribuida al actor\n\n"
        ...
        "IMPORTANTE: Solo es declaración si hay CITA TEXTUAL entre comillas atribuida al actor.\n"
        f"TEXTO: {texto}\n\n"
        "Respondé únicamente SI o NO:"
    )
